    ...
    pub fn update_with_keep_cans(
        ...
        match *event {
            Event::StartKyoku {
                ...
                self.last_tedashis2 = [40, 40, 40, 40];
                self.last_tedashis3[0].fill(40);
                self.last_tedashis3[1].fill(40);
                self.last_tedashis3[2].fill(40);
            ...
            Event::Dahai {
                ...
                self.last_tedashis2[actor_rel] = pai.deaka().as_u8();
                for ac in 1..4 {
                    if self.riichi_accepted[ac]{
                        self.last_tedashis3[ac-1][pai.deaka().as_usize()] = 1;
                    }
                }
                // if self.riichi_accepted[actor_rel] && actor_rel != 0 {
                //     self.last_tedashis3[actor_rel-1][pai.deaka().as_usize()] = 1;
                // }
                if is_riichi {
